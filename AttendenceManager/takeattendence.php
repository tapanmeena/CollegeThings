...
#echo $y;
#$myusername = mysqli_real_escape_string($db,$_POST[$x]);
#}
    #    $myusername = mysqli_real_escape_string($db,$_POST[$x]);
#  $myusername=$_POST[$x];
#        echo $myusername;
    #    $mypassword = mysqli_real_escape_string($db,$x);
    #    $sql = "UPDATE `db_student` SET `attendence`='$myusername'";
...
<h4 style="margin-left:20%">Attendence for Date:-
<?php
...
<td><input type='radio' name=".$row['username']." value=\"1\" checked></td>
<td><input type=\"radio\" name=".$row['username']." value=\"0\"></td>
</tr>";
#$u=$row['username'];
#echo $u;
#$z=document.getElementById("$row[username]");
#$z=$_POST["$u"].value ;
#echo $z."aa"."<br>";
}
#$x=$_POST['present'];
